...
loading_stickers = ['CAACAgIAAxkBAANPZN-0gFHR-yuTDfabyL_thki1AAHpAAI5FgACmYxQSPiB6BR-_jYIMAQ',
...
error_stickers = ['CAACAgIAAxkBAAIBJ2TwpmzmN3hLT7bLpIemKV7hfaCNAAJHAwACbbBCA1JVK_k1xYCCMAQ',
...
def get_started_message():
    return ("I'm here to assist you in converting audio files into text using advanced speech recognition " +
...
def get_init_gdrive_message():
    return ('🔊 <b>Audio Conversion Initiated</b> \n\n'
            'Awesome! You\'ve just taken the first step towards transforming your audio into text. 🎉\n\n'
            '🔗 <b>Link Received:</b> ' 'We\'ve got your link,'
            ' and WhisperBot is ready to download file to convert that audio into text.\n\n'
            )


def get_download_complete_gdrive_message():
    return ('🔄 <b>Processing:</b> ' 'Our WhisperBot is now hard at work,'
            ' using advanced technology to transcribe the spoken content.\n\n'
            '⏳ <b>Please Wait:</b> ' 'The conversion process may take a moment, especially for longer recordings.'
            'Your patience is much appreciated.\n\n'
            '📝 <b>Text Result:</b> ' 'Once the conversion is complete,' ' you\'ll receive '
...
def get_init_message():
    return ('🔊 <b>Audio Conversion Initiated</b> \n\n'
            'Awesome! You\'ve just taken the first step towards transforming your audio into text. 🎉\n\n'
            '🎧 <b>Audio Received:</b> ' 'We\'ve got your audio file,'
            ' and WhisperBot is ready to convert it into text.\n\n'
            '🔄 <b>Processing:</b> ' 'Our WhisperBot is now hard at work,'
            ' using advanced technology to transcribe the spoken content.'
            '⏳ <b>Please Wait:</b> ' 'The conversion process may take a moment, especially for longer recordings.'
            'Your patience is much appreciated.\n\n'
            '📝 <b>Text Result:</b> ' 'Once the conversion is complete,' ' you\'ll receive '
...
def get_error_message_file_size_exceeded():
    return ('🔧 <b>File size is more than 20 Mb</b> \n\n'
